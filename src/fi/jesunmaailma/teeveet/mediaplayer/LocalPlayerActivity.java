...
package fi.jesunmaailma.teeveet.mediaplayer;
...
import fi.jesunmaailma.teeveet.expandedcontrols.ExpandedControlsActivity;
import fi.jesunmaailma.teeveet.utils.CustomVolleyRequest;
import fi.jesunmaailma.teeveet.utils.MediaItem;
import fi.jesunmaailma.teeveet.utils.Utils;
...
public class LocalPlayerActivity extends AppCompatActivity {
    ...
    private void updatePlaybackLocation(PlaybackLocation location) {
        ...
        if (location == PlaybackLocation.LOCAL) {
            if (mPlaybackState == PlaybackState.PLAYING
                ...
                setCoverArtStatus(mSelectedMedia.getImageList());
            }
        } else {
            stopControllersTimer();
            setCoverArtStatus(mSelectedMedia.getImageList());
    ...
    private MediaInfo buildMediaInfo() {
        ...
        movieMetadata.addImage(new WebImage(Uri.parse(mSelectedMedia.getImageList())));
