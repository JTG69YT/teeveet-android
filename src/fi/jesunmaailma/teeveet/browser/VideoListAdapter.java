...
import fi.jesunmaailma.teeveet.R;

import fi.jesunmaailma.teeveet.utils.CustomVolleyRequest;
...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.ViewHolder> {
    ...
    private List<MediaItem> channels;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        final MediaItem item = channels.get(position);
        viewHolder.setTitle(item.getTitle());
        viewHolder.setDescription(item.getSubTitle());
        viewHolder.setImage(item.getImageList(), mAppContext);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View parent, NetworkImageView imgView, View textContainer, TextView titleView, TextView descriptionView) {
            super(parent);
            mParent = parent;
            mImgView = imgView;
