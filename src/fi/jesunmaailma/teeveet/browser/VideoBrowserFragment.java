...
import fi.jesunmaailma.teeveet.mediaplayer.LocalPlayerActivity;
...
public class VideoBrowserFragment extends Fragment implements VideoListAdapter.ItemClickListener,
    ...
    private static final String CATALOG_URL =
            "https://jesunmaailma.ml/teeveet-cms/api/v1/api.php?api_key=1A4mgi2rBHCJdqggsYVx&channels=all&user_id=1";
